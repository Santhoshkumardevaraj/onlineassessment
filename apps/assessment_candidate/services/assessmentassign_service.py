...
class AssessmentAssignService:
    ...
    def update_assessmentconduct_starttime(self, recordid):
        try:
            assessmentconduct_list = (
                self._assessmentconduct_repo.update_assessementconduct_start_time(
                    recordid=recordid
                )
            )
            return assessmentconduct_list
    ...
    def update_assessmentconduct_end(self, recordid=None, type_of_closure=None):
        try:
            assessmentconduct_list = (
                self._assessmentconduct_repo.update_assessmentconduct_end(
                    recordid=recordid, type_of_closure=type_of_closure
                )
            )
            return assessmentconduct_list
        except Exception as Ex:
