...
from apps.commonapp.repositories.typelookup_repository import \
...
class lookupservice:
    ...
    def create_lookup(self, cleaned_data, currentuser):
        ...
        try:
            ...
            model_data = {
                "datafield": datafield,
                "datafor": datafor,
                "dataparamtext": dataparamtext,
                "dataparamvalue": dataparamvalue,
            }
            self.current_repo.create_typelookup(model_data, currentuser)
        except Exception as Ex:
            ServiceError(
                message="Service_typeLookup: Failed to get data:",
    ...
    def get_filtered_lookup(
        self, datafield=None, datafor=None, dataparamtext=None, dataparamvalue=None
    ):
        try:
            return self.current_repo.get_typelookup_filtered(
                datafield=datafield,
                datafor=datafor,
                dataparamtext=dataparamtext,
                dataparamvalue=dataparamvalue,
