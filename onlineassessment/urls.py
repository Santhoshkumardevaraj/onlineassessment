...
from apps.assessment_admin.views.Login import (changepassword_view, login_view,
                                               logout_view)
...
urlpatterns = [
    ...
    path(
        "onlineassessment/", RedirectView.as_view(pattern_name="login", permanent=False)
    ),
    ...
    path(
        "onlineassessment/changepassword/", changepassword_view, name="changepassword"
    ),
