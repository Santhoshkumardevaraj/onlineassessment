...
class CandidateAssessmentReportForm(forms.Form):
    assessment_fromdate = forms.DateField(
        label="Assessment From Date",
        widget=forms.DateInput(
            attrs={
                "type": "date",
                "id": "txtbxassessmentfromdate",
                "class": "form-control",
    ...
    assessment_tillate = forms.DateField(
        label="Assessment Till Date",
        widget=forms.DateInput(
            attrs={
                "type": "date",
                "id": "txtbxassessmenttilldate",
                "class": "form-control",
                "placeholder": "From Date",
            }
        ),
    ...
    assessmentlanguage = forms.ChoiceField(
        label="Language",
        choices=[],
        widget=forms.Select(
            attrs={
                "id": "ddlassessmentlanguage",
                "name": "Language",
                "class": "form-control",
            }
        ),
    ...
    candidatesite = forms.ChoiceField(
        label="Site",
        choices=[],
        widget=forms.Select(
            attrs={
    ...
    candidatelanguage = forms.ChoiceField(
        label="Language",
        choices=[],
        widget=forms.Select(
            attrs={
                "id": "ddlcandidatelanguage",
                "name": "Language",
                "class": "form-control",
            }
        ),
    ...
    candidatefirstname = forms.CharField(
        label="firstname",
        widget=forms.TextInput(
            attrs={
                "id": "txtbxfirstname",
    ...
    candidatelastname = forms.CharField(
        label="lastname",
        widget=forms.TextInput(
            attrs={
                "id": "txtbxlastname",
    ...
    candidateemailid = forms.EmailField(
        label="Email ID",
        widget=forms.TextInput(
            attrs={
                "type": "text",
