...
class TypeLookupRepository:
    ...
    def create_typelookup(self, model_data: dict, currentuser, **kwargs):
        try:
            ...
            raise RepositoryError(
                message="TypeLookup Repository: Failed to create lookup:",
    ...
    def update_typelookup_remove(self, typelookupid, currentuser=None):
        try:
            ...
            raise RepositoryError(
                message="Typelookup Repository: Failed to remove lookup:",
                original_exception=Ex,
            )

    def get_typelookup_filtered(
        self, datafield=None, datafor=None, dataparamtext=None, dataparamvalue=None
    ):
        try:
            ...
            raise RepositoryError(
                message="Typelookup Repository: Failed to get lookup filtered:",
                original_exception=Ex,
            )
    ...
    def get_all_lookup(self):
        try:
            ...
            raise RepositoryError(
                message="Typelookup Repository: Failed to get all lookup:",
                original_exception=Ex,
            )
