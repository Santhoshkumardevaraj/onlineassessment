...
class CandidateAnswerService:
    ...
    def read_candidate_questions(self, assessmentconductid):
        try:
            ...
            assessmentconduct = assessmentconduct_repo.get_assessmentconduct_by_id(
    ...
    def candidate_questions_mark_read(self, recordid):
        try:
            ...
            assessmentconduct = (
                self._candidateanswer_repo.candidate_questions_mark_read(
                    recordid=recordid
                )
            )
    ...
    def get_candidateanswer_by_id(self, recordid=None):
        try:
            ...
            assessmentconduct = self._candidateanswer_repo.get_candidateanswer_by_id(
                recordid=recordid
            )
