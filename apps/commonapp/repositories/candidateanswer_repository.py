...
class CandidateAnswerRepository:
    ...
    def create_candidateanswer(self,assessmentconduct=None,candidate=None,assessment=None,questions=None,currentuser=None):
        try:
    ...
    def read_candidate_questions(self,assessmentconduct=None):
        try:
            return self.model.objects.filter(active=True,assessmentconduct=assessmentconduct).order_by('-created_datetime')
        except Exception as Ex:
