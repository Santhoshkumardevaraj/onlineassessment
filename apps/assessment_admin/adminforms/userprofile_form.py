...
class UserProfileCreationForm(forms.Form):
    ...
    role = forms.ChoiceField(
        ...
        choices=[],
        widget=forms.Select(
            attrs={"id": "ddlrole", "name": "Role", "class": "form-control"}
        ),
        required=True,
    )
    site = forms.ChoiceField(
        ...
        choices=[],
        widget=forms.Select(
            attrs={"id": "ddlsite", "name": "Site", "class": "form-control"}
        ),
        required=True,
    )
    ...
    def _validate_alpha(self, fieldname, value):
        if not re.match(r"^[a-zA-Z\s]+$", value):
            FormError(
                ...
                extra={"Error": fieldname + " must contain only alphabets."},
            )
...
class UserUpdateForm(forms.ModelForm):
    ...
    username = forms.CharField(
        ...
        widget=forms.HiddenInput(
            attrs={"id": "hdfipusername", "class": "form-control", "name": "username"}
        ),
    )
    first_name = forms.CharField(
        max_length=100,
    ...
    last_name = forms.CharField(
        ...
        label="Last Name",
        widget=forms.TextInput(
            attrs={"id": "txtbxlastname", "class": "form-control", "name": "last_name"}
        ),
        required=True,
    )
    email = forms.CharField(
        ...
        label="Email",
        widget=forms.TextInput(
            attrs={"id": "txtbxemail", "class": "form-control", "name": "email"}
        ),
        required=True,
    )
