...
class TypeLookupForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            'datafield': forms.TextInput(attrs={'id': 'txtbxdatafield', 'class': 'form-control', 'placeholder': 'Data Field', 'required': 'required'}),
            'datafor': forms.TextInput(attrs={'id': 'txtbxdatafor', 'class': 'form-control', 'placeholder': 'Data For', 'required': 'required'}),
            'dataparamtext': forms.TextInput(attrs={'id': 'txtbxparamtext', 'class': 'form-control', 'placeholder': 'Param Text', 'required': 'required'}),
            'dataparamvalue': forms.TextInput(attrs={'id': 'txtbxparamvalue', 'class': 'form-control', 'placeholder': 'Param Value', 'required': 'required'}),
        }
