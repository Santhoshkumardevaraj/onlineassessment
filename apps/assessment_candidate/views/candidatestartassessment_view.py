...
class CandidateStartAssessmentView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        try:            
            ...
            if cand_loginid and cand_loginid!='':
                ...
                if candidate_profile and candidate_profile.username:
                    ...
                    if self.assigned_assessment and self.assigned_assessment.assessment_start_datetime:
        ...
        context={
            'pagetitle':'Assign Assessment','AssessmentSearchForm':_searchform,'page_obj':page_obj,
                    ...
                    'assigned_assessment':self.assigned_assessment,"assessment_start_continue":_assessment_start_continue
                                    }
        ...
        if ActionName and ActionName=="startassessment":
            try:
                if self.assigned_assessment and self.assigned_assessment.assessment:
                    all_questions=list(self.assigned_assessment.assessment.questions.filter(active=True))
