...
(function ($) {
  ...
  $container.append('<h5>Customize Style</h5><hr class="mb-2"/>');
  ...
  var $dark_mode_label = $("<label />")
    .append($dark_mode_checkbox)
    .append("Dark Mode");

  var $dark_mode_container = $("<div />", { class: "mb-4" }).append(
    $dark_mode_label
  );
  ...
  var $navbar_variants_colors = createSkinBlock(navbar_all_colors, function () {
    ...
    $("#firstsourcenav").attr("class", "main-header navbar navbar-expand-md");
    ...
    if (navbar_dark_colors.indexOf(color) > -1) {
  ...
  if ($mainsidebar) {
    ...
    console.warn("No .main-sidebar element found on this page.");
  }
