...
from apps.assessment_admin.adminforms.rawassessmentreport_form import RawAssessmentReportForm
...
class ReportRawAssessmentView(View):
    ...
    def get(self,request,*args,**kwargs):
        ...
        context={
            'pagetitle': 'Raw Assessment Report','rawassessreportform':self._rawassessform
                                    }
    ...
    def post(self, request, *args, **kwargs):        
        ...
        try:
            ...
            if ActionName and ActionName=='searchassessment':
                ...
                assessment_list=self._assessmentservice.search_assessment(filter_data,request.user)
                if assessment_list:
        ...
        context = {
            'pagetitle': 'Candidate Assessment Report','rawassessreportform':post_form,'page_obj':self.page_obj
    ...
    def get(self,request,*args,**kwargs):       
        ...
        try:
            ...
            if selected_assessmentid_decoded:
                    ...
                    current_assessment=self._assessmentservice.get_assessment_by_id(selected_assessmentid_decoded) 

                    question_list=self._assessmentservice.read_question_by_assessment(assessment=current_assessment) 
                   
                    for question in question_list:
                        question_Ind_data={}
                        question_Ind_data['question']=question.text
                        question_Ind_data['options']=question.options.all
                        question_Ind_data['correctoption']=question.options.filter(is_correct=True).first().option_text
        ...
        context={
            'pagetitle': 'Raw Assessment Report','rawassessreportform':self._rawassessform,'raw_assessment_data':raw_assessment_data,'current_assessment':current_assessment
                                    }
        return render(request, self.template_name, context)
